...
set -x
#python3 -m pdb ./run_sync_model.py  --model ${DXNN_FILE_PATH} --video ${MP4_FILE_PATH} --config ./yolov5s3_example.json
python3 ./run_sync_model.py  --model ${DXNN_FILE_PATH} --video ${MP4_FILE_PATH} --config ./yolov5s3_example.json
set +x